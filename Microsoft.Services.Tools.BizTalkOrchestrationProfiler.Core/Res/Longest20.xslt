	...
	<xsl:template match="/">
		<html>
            ...
            <table class="TableData">
				...
				<tr>
					<td width="10"></td>
					<td class="TableTitle" colspan="2"><br/><br/><nobr>Top 20 longest running shapes</nobr></td>
				</tr>
			</table>
            ...
            <table class="TableData" width="90%">
				<tr CLASS="TableTitle">
					...
					<td style="color: red"><nobr>MaxDuration (ms)</nobr></td>
					<td><nobr>AvgDuration (ms)</nobr></td>
				</tr>
				
				<xsl:for-each select="CoverageShapes/CoverageShape">
					<xsl:sort select="MaxDurationMillis" data-type="number" order="descending"/>
					
					<xsl:if test="string-length(Text)>0 and position()&lt;20">
						<tr>
							<td width="10"></td>
			...
			<table class="TableData" width="90%">
				<tr CLASS="TableTitle">
					...
					<td style="color: red"><nobr>AvgDuration (ms)</nobr></td>
				</tr>
				
				<xsl:for-each select="CoverageShapes/CoverageShape">
					<xsl:sort select="AvgDurationMillis" data-type="number" order="descending"/>
