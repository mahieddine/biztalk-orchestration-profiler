...
namespace Microsoft.Services.Tools.BizTalkOM
{
    ...
    public class Orchestration : BizTalkBaseObject
    {
        ...
        /// </summary>
        /// <returns></returns>
        public OrchestrationCoverageInfo GetCoverageInfo(string dtaServerName, string dtaDatabaseName, DateTime dateFrom, DateTime dateTo, string[] instancesIds)
        {
            this.GetCoverageShapeInfo(dtaServerName, dtaDatabaseName, dateFrom, dateTo, instancesIds);
        ...
        public void PopulateErrorInfo(string dtaServerName, string dtaDatabaseName, DateTime dateFrom, DateTime dateTo, string[] instancesIds)
        {
            try
            {
                #region SQL
                ...
                sqlOrchTrackingMetrics = sqlOrchTrackingMetrics.Replace("$dateFrom$", dateFrom.ToString("yyyy-MM-dd HH:mm:ss"));
                sqlOrchTrackingMetrics = sqlOrchTrackingMetrics.Replace("$dateTo$", dateTo.ToString("yyyy-MM-dd HH:mm:ss"));
                sqlOrchTrackingMetrics = sqlOrchTrackingMetrics.Replace("$instanceID$", "'" + String.Join("','", instancesIds) + "'");
                sqlOrchTrackingMetrics = sqlOrchTrackingMetrics.Replace("$countInstanceIds$", instancesIds.Length.ToString());          
                ...
                File.WriteAllText("SqlOrchErrorInfo.sql", cmd.CommandText);
        ...
        /// <returns></returns>
        public OrchMetrics GetMetrics(string dtaServerName, string dtaDatabaseName, DateTime dateFrom, DateTime dateTo, string[] instancesIds)
        {
            #region SQL
            ...
            SqlCommand cmd = new SqlCommand(sqlOrchTrackingMetrics);
            File.WriteAllText("SqlOrchTrackingMetrics.sql", cmd.CommandText);
        ...
        /// <param name="dtaServerName"></param>
        /// <param name="dtaDatabaseName"></param>
        private void GetCoverageShapeInfo(string dtaServerName, string dtaDatabaseName, DateTime dateFrom, DateTime dateTo, string[] instancesIds)
        {
            #region SQL
            ...
            sqlOrchTrackingShapeInfo = sqlOrchTrackingShapeInfo.Replace("$dateFrom$", dateFrom.ToString("yyyy-MM-dd HH:mm:ss"));
            sqlOrchTrackingShapeInfo = sqlOrchTrackingShapeInfo.Replace("$dateTo$", dateTo.ToString("yyyy-MM-dd HH:mm:ss"));
            sqlOrchTrackingShapeInfo = sqlOrchTrackingShapeInfo.Replace("$instanceID$", "'" + String.Join("','", instancesIds) + "'");
            sqlOrchTrackingShapeInfo = sqlOrchTrackingShapeInfo.Replace("$countInstanceIds$", instancesIds.Length.ToString());   
            #endregion

            SqlCommand cmd = new SqlCommand(sqlOrchTrackingShapeInfo);
            File.WriteAllText("SqlOrchTrackingShapeMetrics.sql", cmd.CommandText);
