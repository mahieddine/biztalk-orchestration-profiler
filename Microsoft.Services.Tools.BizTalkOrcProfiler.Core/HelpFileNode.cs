...
namespace Microsoft.Sdc.OrchestrationProfiler.Core
{
    ...
    public class HelpFileNode
    {
        ...
        public HelpFileNode(string caption) : this()
        {
            this.caption = caption;
        }

        public HelpFileNode(string caption, string url) : this(caption)
        {
            this.url = url;
        }
        ...
        public override string ToString()
        {
            ...
            {
                return string.Format("<LI><OBJECT type=\"text/sitemap\"><param name=\"Name\" value=\"{0}\"><param name=\"Local\" value=\"{1}\"></OBJECT>", 
                    this.caption, 
                    this.url);
            }
        }
