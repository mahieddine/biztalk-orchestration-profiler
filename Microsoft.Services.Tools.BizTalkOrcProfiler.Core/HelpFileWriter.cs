...
namespace Microsoft.Sdc.OrchestrationProfiler.Core
{
    ...
    public class HelpFileWriter
    {
		...
		{            
			...
			hhcWriter.WriteLine("<!DOCTYPE HTML PUBLIC \"-//IETF//DTD HTML//EN\"><HTML><BODY><OBJECT type=\"text/site properties\">");
		...
		{
			string hhCompilerLocation = new AppSettingsReader().GetValue("HelpCompilerLocation", typeof(string)).ToString();
